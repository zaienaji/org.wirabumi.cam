...
public class UpdateMaintenancePlanNextDue extends DalBaseProcess {
  ...
  protected void doExecute(ProcessBundle bundle) throws Exception {
    /*
     * 1. jika ada maintenance plan yang belum ada nextdue nya --> isi 2. jika ada maintenance plan
     * yang tanggal nextdue nya terlewati --> 2.1 update 2.2 buatkan work order
     */

    OBCriteria<MaintenanceSchedule> msCriteria = OBDal.getInstance()
        .createCriteria(MaintenanceSchedule.class);
