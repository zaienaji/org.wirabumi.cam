...
public class AssetLifeToDateBackground extends DalBaseProcess {
  ...
  protected void doExecute(ProcessBundle bundle) throws Exception {
    ...
    LocalDate nowLocalDate = LocalDate.of(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH) + 1,
    ...
    for (Asset asset : assetList) {
      ...
      LocalDate startLocalDate = LocalDate.of(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH) + 1,
          cal.get(Calendar.DAY_OF_MONTH));
