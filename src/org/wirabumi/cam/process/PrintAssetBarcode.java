...
public class PrintAssetBarcode extends DalBaseProcess {
  ...
  public String getAssetRawTextPrint(String documentID) throws Exception {
    ...
    if (apLineList == null || apLineList.size() == 0)
      throw new OBException(
          "asset print" + assetprint.getDocumentNo() + " does not have any lines to print");
    ...
    for (int i = 0; i < assetKeyList.size(); i++) {
      ...
      // ^FT523,165-->^FT --> field typeset; 523-->field di print di koordinat x=523; 165-->field di
      // print di koordinat y=165
      ...
      // ^PQ print quality; 1--> total quantity label to print, 0--> pause and cut value (no pause),
      // 1-->replicate 1x of each serial number
  ...
  private String buildAssetCodeToPrintKanan(String assetcode, String assetname) {
    /*
     * ini barcode di kanan 192 adalah batas kiri label. makin kecil angkanya makin ke kanan 30
     * adalah batas bawah label. makin kecil angkanya makin ke bawah lable paling banyak 15 karakter
     * 
     * BARIS 1: 192, 129 BARIS 2: 192, 149
     */
    ...
    while (true) {
      ...
      switch (i) {
        case 0:
          sb.append("^FT178,129^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 1:
          sb.append("^FT178,109^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 2:
          sb.append("^FT178,89^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 3:
          sb.append("^FT178,69^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 4:
          sb.append("^FT178,49^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 5:
          sb.append("^FT178,29^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
    ...
    if (assetcode.length() < 25) {
      sb.append("^FT183,175^BQN,2,6");
      sb.append((char) 10);
    } else {
      sb.append("^FT183,175^BQN,2,5");
      sb.append((char) 10);
    }

    sb.append("^FDLA,").append(assetcode).append("^FS");
    sb.append((char) 10);
  ...
  private String buildAssetCodeToPrintKiri(String assetcode, String assetname) {
    ...
    while (true) {
      ...
      switch (i) {
        case 0:
          sb.append("^FT515,129^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 1:
          sb.append("^FT515,109^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 2:
          sb.append("^FT515,89^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 3:
          sb.append("^FT515,69^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 4:
          sb.append("^FT515,49^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
        ...
        case 5:
          sb.append("^FT515,29^A0I,19,26^FH")
              .append((char) 92)
              .append("^FD")
              .append(labelText)
              .append("^FS");
    ...
    if (assetcode.length() < 25) {
      sb.append("^FT518,180^BQN,2,6");
      sb.append((char) 10);
    } else {
      sb.append("^FT518,180^BQN,2,5");
      sb.append((char) 10);
    }
    sb.append("^FDLA,").append(assetcode).append("^FS");
    sb.append((char) 10);
